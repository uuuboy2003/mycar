...
# STEERING_RIGHT_PWM = 100        #pwm value for full right steering
# 
...
# THROTTLE_FORWARD_PWM = 313      #pwm value for max forward throttle
# THROTTLE_STOPPED_PWM = 300      #pwm value for no movement
# THROTTLE_REVERSE_PWM = 286      #pwm value for max reverse throttle
